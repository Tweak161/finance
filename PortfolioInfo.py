...
app = TestApp("127.0.0.1", 7498, 1)

current_time = app.speaking_clock()

print("Current Time = {}".format(current_time))

print("Type of app = {}".format(type(app)))

# print("Connection Stats = {}".format(app.IsConnected ()))

net_liq = app.reqAccountSummary(1, "All", 'NetLiquidation')

print('Net Liquidation of Account = {}'.format(net_liq))
