...
class NoTestApp(NoTestWrapper, NoTestClient):
    def __init__(self, ipaddress, portid, clientid):
        NoTestWrapper.__init__(self)
        NoTestClient.__init__(self, wrapper=self)
...
app = NoTestApp("127.0.0.1", 7498, 11)

## lets get positions
positions_list = app.get_current_positions()
print("positions_list = {}, type(position_list)".format(positions_list), type(positions_list))
print("position_list[1] = {}".format(positions_list[1]))
print("position_list[2] = {}".format(positions_list[2]))
print("position_list[2][0] account id = {}".format(positions_list[2][0]))
# print("position_list[2][1].getSymbol() contract = {}".format(positions_list[2][1].GetSymbol()))
print("type(pAccountInfo.py:473osition_list[2][1]) contract = {}".format(type(positions_list[2][1])))

print("position_list[2][2] position_anzahl = {}".format(positions_list[2][2]))
print("position_list[2][3] id_name= {}".format(positions_list[2][3]))
...
print("accounting_values = {}".format(accounting_values))
...
print("accounting_updates = {}".format(accounting_updates))
